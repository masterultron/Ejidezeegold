...
export const products: Product[] = [
  ...
  { id: "w3", name: "Fluted Sunburst Day-Date Watch (II)", weightInGrams: 71.5, description: "Gold-tone watch with a sunburst dial, diamond-style hour markers, day-date window, fluted bezel, and jubilee bracelet.", category: "Watches", image: "/images/Watches/3.jpeg" },
  { id: "w4", name: "Two-Tone Emerald Dial Watch", weightInGrams: 71.0, description: "Two-tone gold and silver watch with a sunburst emerald-green dial, diamond-style markers, cabochon date accent, fluted bezel, and two-tone jubilee bracelet.", category: "Watches", image: "/images/Watches/4.jpeg" },
  { id: "w5", name: "Pavé Crystal Dial Watch (II)", weightInGrams: 73.8, description: "Gold-tone watch with a fully crystal-paved dial, fluted bezel, and jubilee bracelet.", category: "Watches", image: "/images/Watches/5.jpeg" },
  { id: "w6", name: "Two-Tone Roman Numeral Watch", weightInGrams: 71.8, description: "Two-tone watch with a gold sunburst dial, Roman numeral markers, fluted bezel, and two-tone jubilee bracelet.", category: "Watches", image: "/images/Watches/6.jpeg" },
  ...
  { id: "w13", name: "Pavé Crystal Dial Watch (Petite)", weightInGrams: 43.0, description: "Gold-tone watch with a crystal-paved dial, fluted bezel, and jubilee bracelet.", category: "Watches", image: "/images/Watches/13.jpeg" },
  { id: "w14", name: "Pavé Crystal Dial Watch (Petite II)", weightInGrams: 43.1, description: "Gold-tone watch with a crystal-paved dial, fluted bezel, and jubilee bracelet. Closely resembles w13 — kept as a separate listing pending confirmation of whether these are two distinct pieces or duplicate captures of one.", category: "Watches", image: "/images/Watches/14.jpeg" },
  { id: "w15", name: "Petite Pavé Dial Watch", weightInGrams: 27.5, description: "Small gold-tone watch with a crystal-paved dial, thin case, and plain flat-link bracelet.", category: "Watches", image: "/images/Watches/15.jpeg" },
  { id: "w16", name: "Two-Tone Diamond Marker Watch (Petite)", weightInGrams: 42.9, description: "Two-tone watch with a gold sunburst dial, diamond-style markers, fluted bezel, and two-tone jubilee bracelet.", category: "Watches", image: "/images/Watches/16.jpeg" },
  { id: "w18", name: "Pavé Crystal Dial Watch (Petite III)", weightInGrams: 29.8, description: "Gold-tone watch with a crystal-paved dial, fluted bezel, and jubilee bracelet.", category: "Watches", image: "/images/Watches/18.jpeg" },
  { id: "w19", name: "Blue Sunburst Dial Watch", weightInGrams: 43.5, description: "Gold-tone watch with a pale blue sunburst dial, diamond-style markers, fluted bezel, and gold jubilee bracelet.", category: "Watches", image: "/images/Watches/19.jpeg" },
  { id: "w20", name: "Two-Tone Roman Numeral Watch (Petite)", weightInGrams: 43.1, description: "Two-tone watch, gold sunburst dial with Roman numeral date window, fluted bezel, two-tone jubilee bracelet.", category: "Watches", image: "/images/Watches/20.jpeg" },
  { id: "w21", name: "Petite Woven Chain Bracelet Watch", weightInGrams: 22.4, description: "Small round gold-tone watch with a plain sunburst dial on a dense woven chain-link bracelet.", category: "Watches", image: "/images/Watches/21.jpeg" },
  { id: "w22", name: "Roman Numeral Fluted Watch (Petite)", weightInGrams: 43.5, description: "Gold-tone watch, sunburst dial with Roman numeral markers, fluted bezel, jubilee bracelet.", category: "Watches", image: "/images/Watches/22.jpeg" },
  { id: "w23", name: "Oval Woven Chain Bracelet Watch", weightInGrams: 22.1, description: "Small oval gold-tone watch with a plain sunburst dial on a dense woven beaded chain-link bracelet.", category: "Watches", image: "/images/Watches/23.jpeg" },
  { id: "w24", name: "Roman Numeral Fine Chain Watch", weightInGrams: 24.5, description: "Small round gold-tone watch, Roman numeral markers, plain bezel, fine flat-link bracelet.", category: "Watches", image: "/images/Watches/24.jpeg" },
  { id: "w25", name: "Pavé Crystal Dial Watch (Petite IV)", weightInGrams: 24.3, description: "Small round gold-tone watch with a crystal-paved dial on a fine woven bracelet.", category: "Watches", image: "/images/Watches/25.jpeg" },
  { id: "w26", name: "Diamond Marker Fluted Watch (Petite)", weightInGrams: 42.9, description: "Small round gold-tone watch, sunburst dial with diamond-style markers, fluted bezel, jubilee bracelet.", category: "Watches", image: "/images/Watches/26.jpeg" },
  { id: "w27", name: "Diamond Marker Round Watch (Fine Chain)", weightInGrams: 21.5, description: "Small round gold-tone watch, sunburst dial with diamond-style markers, plain bezel, textured fine-link bracelet.", category: "Watches", image: "/images/Watches/27.jpeg" },
];